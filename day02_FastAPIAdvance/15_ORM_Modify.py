...
# ============== 修改图书==============
def apply_update(obj, data: BaseModel) -> None:
    """
    快速修改属性值
    :param obj: 待改对象
    :param data: 改后对象
    :return:
    """
    """把 Pydantic 对象里『客户端真正传过』的字段赋到 ORM 对象上"""
...
if __name__ == "__main__":
    ...
    uvicorn.run("15_ORM_Modify:app", host="127.0.0.1", port=8007, reload=True)
